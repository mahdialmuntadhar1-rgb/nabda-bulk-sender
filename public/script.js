...
function toggleSource() {
    console.log('[toggleSource] Called');
    const source = document.querySelector('input[name="source"]:checked').value;
    console.log('[toggleSource] Selected source:', source);
    const csvSection = document.getElementById('csvSection');
    const supabaseSection = document.getElementById('supabaseSection');
    const singleSection = document.getElementById('singleSection');
    const sendBtn = document.getElementById('sendBtn');
    console.log('[toggleSource] Sections found:', { csvSection, supabaseSection, singleSection });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('message').addEventListener('input', toggleSource);
